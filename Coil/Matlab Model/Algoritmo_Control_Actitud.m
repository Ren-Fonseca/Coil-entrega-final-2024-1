...
% Controlador PID para ajustar la actitud del satélite.

Kp_Actitud = 0.0025; % Ganancia proporcional para el control de actitud.
Ki_Actitud = 0.0023; % Ganancia integral para el control de actitud.
Kd_Actitud = 0.11; % Ganancia derivativa para el control de actitud.

% Controlador PID para ajustar la velocidad angular del satélite. 
...
% Inicialización de los términos integrales apra ambos lazos de control.
...
% Controlador encargado de ajustar la actitud del CubeSat.

Velocidad_Angular_Deseada = PID_Control_Actitud(Error_Actitud, Kp_Actitud, Ki_Actitud, Kd_Actitud, Error_Integral_Actitud, dt);

% Error de velocidad angular

Error_Velocidad_Angular = Velocidad_Angular_Deseada - Vel_Angular_Inicial;

% Controlador encargado de ajustar la velocidad angular del CubeSat.

Momentos_De_Cuerpo = PID_Control_Velocidad_Angular(Error_Velocidad_Angular, Kp_Vel_Angular, Ki_Vel_Angular, Kd_Vel_Angular, Error_Integral_Vel_Angular, dt);
...
% Función del controlador encargado de ajustar la actitud del CubeSat.

function Velocidad_Angular_Deseada = PID_Control_Actitud(Error_Actitud, Kp, Ki, Kd, Error_Integral_Actitud, dt);
...
Velocidad_Angular_Deseada = Kp * Error_Velocidad_Angular + Ki*Error_Integral_Actitud + Kd*Error_Derivativo;

end

% Función del controlador encargado de ajustar la velocidad angular del CubeSat.

function Momentos_De_Cuerpo = PID_Control_Velocidad_Angular(Error_Velocidad_Angular, Kp, Ki, Kd, Error_Integral_Vel_Angular, dt)

Error_Integral_Vel_Angular = Error_Integral_Vel_Angular + Error_Velocidad_Angular*dt;
Error_Derivativo = Error_Velocidad_Angular/dt;
Momentos_De_Cuerpo = Kp*Error_Velocidad_Angular + Ki*Error_Integral_Vel_Angular + Kd*Error_Derivativo;
